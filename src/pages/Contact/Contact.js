...
const Contact = () => {
  ...
  const notify = () => toast("Thanks for you mail, back you soon!");
  const {
    register,
    handleSubmit,
    reset,
  ...
  const onSubmit = (message) => {
    ...
    (async () => {
      const { data } = await axios.post(
        "https://zany-puce-moth-hose.cyclic.app/api/sendmail",
        message
      );
      if (data) {
        setIsLoading(false);
  ...
  return (
    <div id="contact" className=" 2xl:max-w-7xl xl:max-w-6xl mx-auto">
         <ToastContainer />
      ...
      <div className="w-full flex flex-col lg:flex-row justify-center gap-10">
        ...
        >
          ...
          <p className="text-gray-500 text-base lg:text-lg">
            ...
            <br />
            <br />
            If you have any Query feel free to contact with me. I am always excited to discuss with you.
            <br />
            <br />
            Phone : <span className="text-accent ml-2">+8801622098349</span>
            <br />
            Email :
            <span className="text-accent ml-2">
              rabeyaasumi@gmail.com
            </span>
          </p>
          <div className="mt-5">
